...
namespace FigureDB.Model.Migrations
{
    ...
    [Migration("20210117142930_changerecommendschema")]
    partial class changerecommendschema
    {
            ...
            modelBuilder.Entity("FigureDB.Model.Entities.FigureImage", b =>
                {
                    ...
                    b.Property<int>("FigureImageType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FigureDB.Model.Entities.Recommand", b =>
                {
                    ...
                    b.HasOne("FigureDB.Model.Entities.FigureImage", "FigureImage")
                        .WithMany("Recommands")
                        .HasForeignKey("FigureImageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
